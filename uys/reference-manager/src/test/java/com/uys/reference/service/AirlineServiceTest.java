...
class AirlineServiceTest {
    ...
    void getAllAirlines_Success() {
        ...
        when(airlineMapper.toResponse(any(Airline.class))).thenReturn(response);
    ...
    void getActiveAirlines_Success() {
        ...
        when(airlineRepository.findByActiveTrue(pageable)).thenReturn(airlinePage);
        when(airlineMapper.toListResponse(testAirline)).thenReturn(
            AirlineDto.ListResponse.builder()
                .airlineCode("TK")
                .airlineName("Turkish Airlines")
                .country("Turkey")
                .active(true)
