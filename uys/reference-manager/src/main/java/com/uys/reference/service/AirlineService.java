...
public class AirlineService {
     ...
     */
    @Transactional(readOnly = true)
    public long getActiveAirlineCount() {
        log.debug("Getting active airline count");
        return airlineRepository.countByActiveTrue();
    }
     ...
     */
    @Transactional(readOnly = true)
    public long getInactiveAirlineCount() {
        log.debug("Getting inactive airline count");
        return airlineRepository.countByActiveFalse();
    }
     ...
     */
    @Transactional(readOnly = true)
    public List<AirlineDto.ListResponse> getAirlinesByCountryOrdered(String country) {
        log.debug("Getting airlines by country ordered: {}", country);
        List<Airline> airlines = airlineRepository.findByCountryOrderByAirlineNameAsc(country);
        return airlineMapper.toListResponseList(airlines);
    }
} 